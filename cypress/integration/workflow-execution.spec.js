...
describe('Test workflow configuration and execution', () => {
    ...
    it('TODO Selecting a region on the map should "automatically fill subset_WFS.featureids input"', () => {
        ...
        cy.window().then((window) => {
            ...
            cy.simulateOpenLayersEvent(window.ol, window.cyCurrentMap, 'pointerdown', -200, 100);
            cy.simulateOpenLayersEvent(window.ol, window.cyCurrentMap, 'pointerup', -200, 100);
        })
